  ...
  return (
    <section id="about" className="py-20">
      <div className="container mx-auto px-0">
        ...
        <p className="text-lg text-gray-600 mb-6 px-5">
          I&apos;m a passionate developer with expertise in Javascript, Python, Next.js, React.js, and Tailwind CSS. I love creating
